  ...
  return (
    <>
      <motion.div
        initial={{ y: "100%" }}
        animate={{ y: "0%" }}
  transition={{ y: { delay: 0, duration: props.finishedLoading ? 0 : 0.5 } }}
      ...
      >
        <div className="flex flex-col space-y-8 justify-center items-center">
          <div className="flex flex-col justify-center items-center space-y-5">
            {/* Github Icon */}
            <IconClickableWithAnimation Icon={GithubIcon} href={"https://github.com/aeiyannn"} />
            {/* Linkedin icon */}
            <IconClickableWithAnimation Icon={LinkedinIcon} href={"https://www.linkedin.com/in/aeiyan-khan/"} />
            {/* Instagram Icon */}
            {/* <IconClickableWithAnimation Icon={InstagramIcon} href={"https://www.instagram.com/xredme/"} /> */}
            {/* Youtube Icon */}
            <IconClickableWithAnimation Icon={YoutubeIcon} href={"https://www.youtube.com/@aeiyankhan3489"} />
          </div>
      ...
      <motion.div
        initial={{ y: "170%" }}
        animate={{ y: "0%" }}
  // remove delay so the email bar animates immediately
  transition={{ y: { delay: 0, duration: props.finishedLoading ? 0 : 0.5 } }}
      ...
      >
        <div className="flex flex-col space-y-24 justify-center items-center">
          ...
          <motion.div
            ...
            className=""
          >
            <a href="mailto:aeiyankhan2@gmail.com" target={"_blank"} rel="noreferrer">
              <span className=" font-Header tracking-wider text-gray-400 hover:text-AAsecondary hover:cursor-pointer">
                aeiyankhan2<span className="text-AAsecondary">@</span>gmail<span className="text-AAsecondary">.</span>com
              </span>
            </a>
          </motion.div>
