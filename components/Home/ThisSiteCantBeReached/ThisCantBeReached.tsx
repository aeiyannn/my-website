...
export default function ThisCantBeReached() {
  ...
  let CenterHeight = 0;
  React.useEffect(() => {
    // show text immediately (remove artificial delay)
    setShowText(true);
  }, []);
  ...
  transition={{delay:0,duration:1}}
        className="relative w-9 h-10 ">
          ...
          <motion.div
            ...
            transition={{ scaleY: { delay: 0, duration: 1 } }}
          ...
          <motion.div
            initial={{ opacity: "100%" }}
            animate={{ opacity: "0%" }}
            transition={{ opacity: { delay: 0, duration: 0 } }}
            className=""
          >
        ...
        {/* Text start from here */}
          ...
          initial={{opacity:1}}
          animate={{ opacity: 0 }}
          transition={{ opacity: { delay: 0, duration: 0.5 } }}
        ...
        >
          <span className="text-gray-600 font-Header text-2xl">
            ...
            {ShowText ? (
              <motion.span
                ...
                transition={{ scale: { delay: 0, duration: 0.5 } }}
                className="font-bold"
              >
                actually can
              </motion.span>
          ...
          <span className="text-gray-500 text-md">
            <span className="font-bold">www.aeiyankhan.vercel.app </span>
            unexpectedly{" "}
            {ShowText ? (
              <motion.span
                animate={{ scale: ["100%", "140%"] }}
                transition={{ scale: { delay: 0, duration: 1 } }}
                className="font-bold"
              >
                opened
              </motion.span>
